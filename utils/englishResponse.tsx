...
export const getMessageResponse = async (message: string, messages: Message[], addMessage: (msg: Message) => void) => {
...
const getGPTResponse = async () => {
    ...
    useEffect(() => {
        ...
        console.log((messages.length == 0) ? `${prompt} "${ transcript.text }"` : transcript.text);
    ...
    const handleClick = async () => {
        ...
        console.log((messages.length == 0) ? `${prompt} "${ liveMessage }"` : liveMessage);
